<?php
/**
 * widgets.php - custom widget classes
 */
class WP_Widget_IIH_Latest_News extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		<span class="widget-show-all-link"><a href="/category/news">Show all news</a></span>
